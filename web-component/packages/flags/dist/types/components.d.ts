...
declare global {
    interface HTMLFlagIconElement extends Components.FlagIcon, HTMLStencilElement {
    }
    var HTMLFlagIconElement: {
        prototype: HTMLFlagIconElement;
        new (): HTMLFlagIconElement;
    };
    interface HTMLElementTagNameMap {
        "flag-icon": HTMLFlagIconElement;
    }
}
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "flag-icon": LocalJSX.FlagIcon & JSXBase.HTMLAttributes<HTMLFlagIconElement>;
        }
    }
}
