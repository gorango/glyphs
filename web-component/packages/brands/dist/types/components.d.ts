...
declare global {
    interface HTMLBrandIconElement extends Components.BrandIcon, HTMLStencilElement {
    }
    var HTMLBrandIconElement: {
        prototype: HTMLBrandIconElement;
        new (): HTMLBrandIconElement;
    };
    interface HTMLElementTagNameMap {
        "brand-icon": HTMLBrandIconElement;
    }
}
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "brand-icon": LocalJSX.BrandIcon & JSXBase.HTMLAttributes<HTMLBrandIconElement>;
        }
    }
}
