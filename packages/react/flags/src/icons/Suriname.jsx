...
const renderString = ({ variant, strokeWidth='3', strokeLinecap='round', strokeLinejoin='round' }) => {
  switch (variant) {    
    ...
    case 'square':
      return (
        <>
          <g clip-path="url(#clip0)"><path d="M80 0H0V80H80V0Z" fill="#219653"/><path d="M80 40H0" stroke="#F2F2F2" stroke-width="48"/><path d="M80 40H0" stroke="#EB5757" stroke-width="32"/><path d="M39.9999 25L42.3824 36.0812L50.1445 36.0557L43.8549 42.8788L46.2696 53.9443L39.9999 47.08L33.7302 53.9443L36.145 42.8788L29.8553 36.0557L37.6174 36.0812L39.9999 25Z" fill="#F2C94C"/></g>
