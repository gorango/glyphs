    ...
    case 'circle':
      return (
        <>
          ...
          <g mask="url(#mask0)"><path d="M80 0H0V80H80V0Z" fill="#EB5757"/><path d="M32 0V41.3043V80H0V0H32Z" fill="#219653"/><path d="M32 58C41.9411 58 50 49.9411 50 40C50 30.0589 41.9411 22 32 22C22.0589 22 14 30.0589 14 40C14 49.9411 22.0589 58 32 58Z" fill="#F2C94C"/><path d="M22 30H42V42C42 47.5228 37.5228 52 32 52C26.4772 52 22 47.5228 22 42V30Z" fill="#F2F2F2"/><path d="M24.5 32.5H39.5V42C39.5 46.1421 36.1421 49.5 32 49.5C27.8579 49.5 24.5 46.1421 24.5 42V32.5Z" stroke="#EB5757" stroke-width="5"/></g>
        </>
      )
  }
}
