  ...
  switch (variant) {    
    case 'rectangle':
      return (
        <>
          <path
            d="M120 0H0V13.3333H120V0Z"
            fill="#333333"
          />
          <path
            d="M120 13.3333H0V26.6666H120V13.3333Z"
            fill="#F2C94C"
          />
          <path
            d="M120 26.6667H0V40.0001H120V26.6667Z"
            fill="#EB5757"
          />
          <path
            d="M120 40H0V53.3333H120V40Z"
            fill="#333333"
          />
          <path
            d="M120 53.3333H0V66.6666H120V53.3333Z"
            fill="#F2C94C"
          />
          <path
            d="M120 66.6667H0V80.0001H120V66.6667Z"
            fill="#EB5757"
          />
          <circle
            cx="60"
