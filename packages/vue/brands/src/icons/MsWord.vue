    ...
    <g>      
      <template v-if="variant === 'color'">
        ...
        <path
          ...
          fill="white"
        />
        <defs><linearGradient id="paint0_linear34Le" x1="22" y1="19" x2="76" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#2B78B1"/><stop offset="1" stop-color="#338ACD"/></linearGradient><linearGradient id="paint1_linear34Le" x1="22" y1="65.5938" x2="76" y2="65.5938" gradientUnits="userSpaceOnUse"><stop stop-color="#1B366F"/><stop offset="1" stop-color="#2657B0"/></linearGradient><linearGradient id="paint2_linear34Le" x1="45.625" y1="49" x2="76" y2="49" gradientUnits="userSpaceOnUse"><stop stop-color="#20478B"/><stop offset="1" stop-color="#2D6FD1"/></linearGradient><linearGradient id="paint3_linear34Le" x1="45.625" y1="33.25" x2="76" y2="33.25" gradientUnits="userSpaceOnUse"><stop stop-color="#215295"/><stop offset="1" stop-color="#2E84D3"/></linearGradient><linearGradient id="paint4_linear34Le" x1="4" y1="42.25" x2="46.75" y2="42.25" gradientUnits="userSpaceOnUse"><stop stop-color="#223E74"/><stop offset="1" stop-color="#215091"/></linearGradient><linearGradient id="paint5_linear34Le" x1="4" y1="42.25" x2="46.75" y2="42.25" gradientUnits="userSpaceOnUse"><stop stop-color="#223E74"/><stop offset="1" stop-color="#215091"/></linearGradient></defs>
      </template>
