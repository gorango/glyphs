      ...
      <g>        
        ${variant === "color" && svg`
          ...
          <path
            ...
            fill="white"
          />
          <defs><linearGradient id="paint0_linearEgUl" x1="40" y1="7.5" x2="29.5716" y2="72.1458" gradientUnits="userSpaceOnUse"><stop stop-color="#00B1FF"/><stop offset="1" stop-color="#006BFF"/></linearGradient></defs>
        `}
        ${variant === "solid" && svg`
          <path
            fill-rule="evenodd"
...
define('brands-fb-messenger', BrandsFbMessenger)
