...
declare global {
    interface HTMLEdgyIconElement extends Components.EdgyIcon, HTMLStencilElement {
    }
    var HTMLEdgyIconElement: {
        prototype: HTMLEdgyIconElement;
        new (): HTMLEdgyIconElement;
    };
    interface HTMLElementTagNameMap {
        "edgy-icon": HTMLEdgyIconElement;
    }
}
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "edgy-icon": LocalJSX.EdgyIcon & JSXBase.HTMLAttributes<HTMLEdgyIconElement>;
        }
    }
}
